...
<div class="col-lg-4 " >
  <div class="card">
      <div class="">
       <form class=" d-lg-block w-28 mt-0 ml-5 mr-5 mb-5" action="/produit/ajout" method="POST">
       @csrf
       ...
       <td><input type =text name="NomProduit" placeholder="LIBELLE" class="form-control" required></td>
       </tr>
       <tr>
       <td><h4>Marque </h4> </td>
       <td><input type =text name="marque" placeholder="BRAND name" class="form-control" required></td>
       </tr>
       <tr>
       <td><h4>Logo(image) </h4> </td>
       <td><input type="file" class="btn" name="logo" accept="image/*" capture></td>
       </tr>
       <tr>
       <td><h4>Prix </h4> </td>
       <td><input type =text name="prixU" placeholder="BRAND name" class="form-control" required></td>
       </tr>
       <td><h4>SLUG </h4></td>
       <td><input type =text name="SlugProduit" placeholder="SLUG" class="form-control" required></td>
       <tr>
       <td><h4>AJOUTER DESCRIPTION </h4></td>
       <td><textarea name=description class="form-control" required></textarea><br></td>
       </tr>
       <tr >
       <td colspan="2" ><br><label class="label"><h4 class=" float-center">AJOUTEZ UNE image</h4> </label><br>
       <input type="file" class="btn" name="image" accept="image/*" capture required> 
       </tr>
       </table><br>
       @if ($errors->any())
